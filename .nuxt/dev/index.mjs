...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, getRequestURL, getResponseHeader, getQuery as getQuery$1, readBody, getRouterParam, setHeader, getResponseStatus, createError, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getResponseStatusText } from 'file:///Users/miadugas/Desktop/grave_goods/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///Users/miadugas/Desktop/grave_goods/node_modules/@vue/shared/dist/shared.cjs.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/miadugas/Desktop/grave_goods/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file:///Users/miadugas/Desktop/grave_goods/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/miadugas/Desktop/grave_goods/node_modules/vue/server-renderer/index.mjs';
import destr, { destr as destr$1 } from 'file:///Users/miadugas/Desktop/grave_goods/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/miadugas/Desktop/grave_goods/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/miadugas/Desktop/grave_goods/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/miadugas/Desktop/grave_goods/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/miadugas/Desktop/grave_goods/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/miadugas/Desktop/grave_goods/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file:///Users/miadugas/Desktop/grave_goods/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/miadugas/Desktop/grave_goods/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/miadugas/Desktop/grave_goods/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/miadugas/Desktop/grave_goods/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/miadugas/Desktop/grave_goods/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/miadugas/Desktop/grave_goods/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///Users/miadugas/Desktop/grave_goods/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/miadugas/Desktop/grave_goods/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/miadugas/Desktop/grave_goods/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/miadugas/Desktop/grave_goods/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/miadugas/Desktop/grave_goods/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/miadugas/Desktop/grave_goods/node_modules/errx/dist/index.js';
import { isVNode, toValue, isRef } from 'file:///Users/miadugas/Desktop/grave_goods/node_modules/vue/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/miadugas/Desktop/grave_goods/node_modules/unhead/dist/server.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///Users/miadugas/Desktop/grave_goods/node_modules/unhead/dist/plugins.mjs';
import { walkResolver } from 'file:///Users/miadugas/Desktop/grave_goods/node_modules/unhead/dist/utils.mjs';
import { isAbsolute } from 'file:///Users/miadugas/Desktop/grave_goods/node_modules/pathe/dist/index.mjs';
import localAdapter from 'file:///Users/miadugas/Desktop/grave_goods/node_modules/db0/dist/connectors/better-sqlite3.mjs';
import { fileURLToPath } from 'node:url';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///Users/miadugas/Desktop/grave_goods/node_modules/ipx/dist/index.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/miadugas/Desktop/grave_goods/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/miadugas/Desktop/grave_goods","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/miadugas/Desktop/grave_goods/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/miadugas/Desktop/grave_goods/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/miadugas/Desktop/grave_goods/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/miadugas/Desktop/grave_goods/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "/Users/miadugas/Desktop/grave_goods/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  },
  "ipx": {
    ...
    "fs": {
      "dir": [
        "/Users/miadugas/Desktop/grave_goods/public"
      ]
    },
    "http": {
      "domains": []
...
const _6MCa0_jy9blepqce37t_eyCLWUOlhIkGwtn9RNKdTc = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/miadugas/Desktop/grave_goods";
...
const _s3ZYhUCaokoWQ2IuFAmCMscfqJEIDeHCP5bdHOakL8 = (nitroApp) => {
...
const plugins = [
  _6MCa0_jy9blepqce37t_eyCLWUOlhIkGwtn9RNKdTc,
_s3ZYhUCaokoWQ2IuFAmCMscfqJEIDeHCP5bdHOakL8
];
...
const getServerEntry = () => import('file:///Users/miadugas/Desktop/grave_goods/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///Users/miadugas/Desktop/grave_goods/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _pQ645y = eventHandler(async (event) => {
  ...
  return await import('file:///Users/miadugas/Desktop/grave_goods/.nuxt/content/database.compressed.mjs').then((m) => m[collection]);
});
...
const _Kp_fZT = eventHandler(async (event) => {
...
const _ya08cF = lazyEventHandler(() => {
...
const _lazy_eNv0VH = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_eNv0VH, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/sql_dump', handler: _pQ645y, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/query', handler: _Kp_fZT, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _ya08cF, lazy: false, middleware: false, method: undefined },
  { route: '/_fonts/**', handler: _lazy_eNv0VH, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_eNv0VH, lazy: true, middleware: false, method: undefined }
];
